...
def build_pass_secret_text() -> str:
    """Build pass.secret from policy.users.

    Ground truth requirement:
      - pass.secret must contain ONLY minimal user/password/member lines.
      - Do NOT mutate user_secrets.json during apply (avoid lock inversion / deadlock).
    ...
    # End file with a newline (nice-to-have); still 'minimal'.
    return "\n".join(lines) + ("\n" if lines else "")
